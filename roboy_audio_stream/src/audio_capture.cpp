  ...
  class RosGstCapture
  {
    public:
      RosGstCapture()
      {
        ...
        _pub = _nh.advertise<roboy_communication_cognition::AudioData>("/roboy/cognition/audio/" + _topic, 10, true);
      ...
      void publish( const roboy_communication_cognition::AudioData &msg )
      {
        _pub.publish(msg);
      }
      ...
      static GstFlowReturn onNewBuffer (GstAppSink *appsink, gpointer userData)
      {
        ...
        roboy_communication_cognition::AudioData msg;
...
{
  ros::init(argc, argv, "roboy_audio_capture");
  gst_init(&argc, &argv);
