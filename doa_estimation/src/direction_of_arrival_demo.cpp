...
#include "roboy_communication_cognition/DirectionVector.h"
...
int main(int argc, char *argv[]) {
    ...
    ros::NodeHandle n;
    ros::Publisher doa_pub = n.advertise<roboy_communication_cognition::DirectionVector>("/roboy/cognition/audio/direction_of_arrival",
                                                                      1000);
    ...
    float polar_angle;
    int mic;
    roboy_communication_cognition::DirectionVector msg;
